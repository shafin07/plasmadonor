...
include 'layoutGeneral/_header.php';

include 'layoutGeneral/_top_nav.php';
?>
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group col-md-12">
                ...
                <form class="form-horizontal" method="post" action="homeGeneral.php">
                    <div class="form-group">
...
<?php include 'layoutGeneral/_footer.php'; ?>