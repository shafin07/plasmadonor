    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="localhost/MVC/Views/homeGeneral.php">Blood Bank</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
             <li class="<?php
                        ...
                        ?>"><a href="Views/homeGeneral.php">Home</a></li>
                        <li class="<?php
                        ...
                        ?>"><a href="Models/donor.php">New Donor</a></li>
                        
                        <li class="<?php if(isset($setMemberActive)) { echo $setMemberActive; } else { echo ''; } ?>">
                            <a href="Models/members.php">Our Members</a>
                        </li>
